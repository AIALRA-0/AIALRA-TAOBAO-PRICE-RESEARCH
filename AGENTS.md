...
这份文件约束维护和运行 `$taobao-price-research` 的 Agent
...
- 只通过 `.agents/skills/taobao-price-research/scripts/runner.py` 运行 Skill
...
- 根目录验证脚本
- CI 工作流
- `.agents/skills/taobao-price-research/` 下的全部文件
